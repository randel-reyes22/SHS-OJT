...
<html>
	...
	<title>Change Password &mdash; Guidance Office Scheduler</title>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/change.jpg)">
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Change your password.</span>
					...
					<form action="../php/changePass.php" method="POST">
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input class="sr-only" for="username"><h1><?php echo  $_SESSION['SESS_FIRST_NAME']; ?></h1></input>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="password" id="psw" name="oldpass" class="form-control" placeholder="Your old password">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input class="form-control" type="password" name="conpassword" id="conpassword" placeholder="Confirm password" required onkeyup="checkPass(); return false;" /> <span id="check" class="confirmMessage"></span> 
							</div>
						</div>
...
<a id="bottom"></a>
	...
	<script src="../js/changepass2.js"></script>
	<!-- jQuery -->
